...
const (
	MerchantService_MerchantPost_FullMethodName      = "/merchant.MerchantService/MerchantPost"
	MerchantService_MerchantPut_FullMethodName       = "/merchant.MerchantService/MerchantPut"
	MerchantService_MerchantDetailGet_FullMethodName = "/merchant.MerchantService/MerchantDetailGet"
	MerchantService_MerchantListGet_FullMethodName   = "/merchant.MerchantService/MerchantListGet"
	MerchantService_MerchantDelete_FullMethodName    = "/merchant.MerchantService/MerchantDelete"
)
...
func (c *merchantServiceClient) MerchantPost(ctx context.Context, in *request.MerchantPost, opts ...grpc.CallOption) (*MerchantUpsertRes, error) {
	...
	err := c.cc.Invoke(ctx, MerchantService_MerchantPost_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *merchantServiceClient) MerchantPut(ctx context.Context, in *request.MerchantPut, opts ...grpc.CallOption) (*MerchantUpsertRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MerchantUpsertRes)
	err := c.cc.Invoke(ctx, MerchantService_MerchantPut_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *merchantServiceClient) MerchantDetailGet(ctx context.Context, in *request.MerchantDetailGet, opts ...grpc.CallOption) (*MerchantDetailGetRes, error) {
	...
	err := c.cc.Invoke(ctx, MerchantService_MerchantDetailGet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *merchantServiceClient) MerchantListGet(ctx context.Context, in *request.MerchantListGet, opts ...grpc.CallOption) (*MerchantListGetRes, error) {
	...
	err := c.cc.Invoke(ctx, MerchantService_MerchantListGet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *merchantServiceClient) MerchantDelete(ctx context.Context, in *request.MerchantDelete, opts ...grpc.CallOption) (*status.Empty, error) {
	...
	err := c.cc.Invoke(ctx, MerchantService_MerchantDelete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MerchantService_MerchantPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MerchantService_MerchantPost_FullMethodName,
	}
...
func _MerchantService_MerchantPut_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MerchantService_MerchantPut_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MerchantService_MerchantDetailGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MerchantService_MerchantDetailGet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MerchantService_MerchantListGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MerchantService_MerchantListGet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MerchantService_MerchantDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MerchantService_MerchantDelete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
