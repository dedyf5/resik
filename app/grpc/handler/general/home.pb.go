...
func (x *HomeRequest) GetCommon() *common.Request {
	if x != nil {
		return x.Common
	}
	return nil
...
func (x *App) Reset() {
	*x = App{}
	if protoimpl.UnsafeEnabled {
		mi := &file_app_grpc_handler_general_home_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*App) Descriptor() ([]byte, []int) {
	return file_app_grpc_handler_general_home_proto_rawDescGZIP(), []int{2}
}
...
func (x *Lang) Reset() {
	*x = Lang{}
	if protoimpl.UnsafeEnabled {
		mi := &file_app_grpc_handler_general_home_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Lang) Descriptor() ([]byte, []int) {
	return file_app_grpc_handler_general_home_proto_rawDescGZIP(), []int{3}
}
...
var file_app_grpc_handler_general_home_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x36, 0x0a, 0x0b, 0x48, 0x6f, 0x6d, 0x65, 0x52,
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x06, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x22,
	...
	0x66, 0x61, 0x75, 0x6c, 0x74, 0x42, 0x32, 0x5a, 0x30, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	...
	0x72, 0x2f, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x6c, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_app_grpc_handler_general_home_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_app_grpc_handler_general_home_proto_depIdxs = []int32{
	4, // 0: general.HomeRequest.common:type_name -> common.Request
...
func file_app_grpc_handler_general_home_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_app_grpc_handler_general_home_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*App); i {
			case 0:
				return &v.state
			case 1:
		...
		file_app_grpc_handler_general_home_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Lang); i {
			case 0:
				return &v.state
			case 1:
