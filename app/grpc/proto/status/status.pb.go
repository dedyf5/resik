...
type Empty struct {
	...
	Code    string `protobuf:"bytes,1,opt,name=Code,proto3" json:"-"`        
	Message string `protobuf:"bytes,2,opt,name=Message,proto3" json:"-"`  
}
...
var file_app_grpc_proto_status_status_proto_rawDesc = []byte{
	...
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x43, 0x6f, 0x64, 0x65, 0x18, 0x01,
	...
	0x28, 0x09, 0x52, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x2f, 0x5a, 0x2d, 0x67,
...
var file_app_grpc_proto_status_status_proto_goTypes = []interface{}{
...
func file_app_grpc_proto_status_status_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_app_grpc_proto_status_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Status); i {
			case 0:
				return &v.state
			case 1:
		...
		file_app_grpc_proto_status_status_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
